...
const Home = () => {
  return (
    <div>
      <div className="mt-3 ml-4 text-2xl font-normal text-doer-purple sm:text-4xl">
        MeetHack
      </div>
      <div align="center">
      ...
      <div align="center" className="mt-12">
        <div
          className="my-20 bg-thin-purple py-10 shadow-xl
                          sm:my-40 md:py-10"
        >
          <div
            ...
            return (
              ...
              >
                <div className="grid w-4/5 grid-cols-1 sm:w-5/6 sm:grid-cols-2">
                  ...
                  <p
                    className="justify-content-center text-justify align-middle
      ...
      <div className="lg:mx-30 grid sm:grid-cols-2 md:mx-20">
        <div className="m-auto w-5/12 sm:w-2/3">
          <img src="https://images-ext-2.discordapp.net/external/qtfcHSSS-dP6AuQM5RKS5QFHCPsPyFtU5TqRAifP8AE/https/doer.vercel.app/og_img.png"></img>
        </div>
